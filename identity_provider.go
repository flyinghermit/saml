...
type ResponseWriter interface {
	// Write writes HTTP response with SAML authentication response,
	// which is an HTML POST form with SAML authentication data.
...
// response, which is an HTML POST form with SAML authentication data.
